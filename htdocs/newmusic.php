<!DOCTYPE html>
    <html lang="ru">
      ...
      <body >
        ...
        <div class="container">
          <h1 class="jumbotron-heading">Музыкальные новинки</h1>
        </div>
      </section>
      ...
      <div class="container mt-5">
        ...
        <div class="d-flex flex-wrap">
          ...
          $mysql = new mysqli('localhost', 'root', 'root', 'register-bd');
            ...
            $result = $mysql->query("SELECT `id` FROM `new_music`");
          ...
          ?>
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <?php
                        $a = $i + 1;
                        $art = $mysql->query("SELECT `Name` FROM `execotur` WHERE `id` = (SELECT `id_executor` FROM `audio` WHERE `id` = (SELECT `id_audio` FROM `new_music` WHERE `id` = '$a'))");
                  ...
                  <?php
                        ...
                        $art2 = $mysql->query("SELECT `Name` FROM `audio` WHERE `id` = (SELECT `id_audio` FROM `new_music` WHERE `id` = '$a')");
